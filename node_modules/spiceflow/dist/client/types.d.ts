...
type ReplaceBlobWithFiles<in out RecordType extends Record<string, unknown>> = {
    [K in keyof RecordType]: RecordType[K] extends any ? RecordType[K] : RecordType[K] extends Blob | Blob[] | {
...
export declare namespace SpiceflowClient {
    ...
    export type ClientResponse<Res extends Record<number, unknown>> = {
        ...
        data: null;
        error: Exclude<keyof Res, 200> extends never ? SpiceflowFetchError<number, any> : {
